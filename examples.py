...
freesound_client.set_token("<YOUR_API_KEY_HERE>", "token")
...
print sound.analysisound.lowlevel.spectral_centroid.as_dict()
print
...
mfcc = analysis.lowlevel.mfcfreesound_client.mean
print "Mfccs:", mfcc
...
for similar_sound in results_pager.results:
...
print "\t----- PAGE 1 -----"
for sound in results_pager.results:
...
for sound in results_pager.results:
    ...
    print sound.analysisound.lowlevel.spectral_flatness_db.mean
print "\t----- PAGE 2 -----"
results_pager = results_pager.next_page()
for sound in results_pager.results:
    print "\t-", sound.name, "by", sound.username, ", with duration of",
...
print "Num results:", results_pager.count
print "\t----- PAGE 1 -----"
for bookmark_category in results_pager.results:
